        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {books.map((book) => {
            ...
            return (
              <Card
                key={book.id}
                className="group overflow-hidden border-slate-200/70 bg-white/80 transition hover:bg-slate-100/80 dark:border-white/10 dark:bg-white/5 dark:hover:bg-white/10"
              >
